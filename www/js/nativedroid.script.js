		...
		basic : {
			dateFormat : {
				language : {
					...
					type : "short",
					en : {
						dayShort : ["Sun","Lun","Tue","Wed","Thu","Fri","Sat"],
					...
					fr : {
						...
						monthShort : ["Jan","Fev","Mar","Avr","Mai","Jui","Juil","Aou","Sep","Oct","Nov","Dec"],
						monthLong : ["Janvier","Fevrier","Mars","Avril","Mai","Juin","Juillet","Aout","Septembre","Octobre","Novembre","Decembre"],
						order : function(day,dayStr,date,month,monthStr,year) {
